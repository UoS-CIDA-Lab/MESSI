...
<sub>MESSI 0.1.0: a ten-second attacking move from a deterministic 11-v-11 rollout with 80 Hz physics, 10 Hz decisions, and exact 20 fps rendering. The GIF and linked H.264 clip both use a 1,920×1,080 source.</sub>
